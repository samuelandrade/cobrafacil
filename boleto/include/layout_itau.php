...
<table cellspacing=0 cellpadding=0 width=666 border=0><tr><td class=cp width=150>
  <span class="bc">Banco Itaú SA<!--<IMG
...
mecânica - <b class=cp>Ficha de Compensação</b></div></TD></TR><TR><TD class=ct  colspan=3 ></TD></tr></tbody></table><TABLE cellSpacing=0 cellPadding=0 width=666 border=0><TBODY><TR><TD vAlign=bottom align=left height=50><?php echo  fbarcode($dadosboleto["codigo_barras"]); ?>
 </TD>
