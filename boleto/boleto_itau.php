...
$dadosboleto["sacado"] = utf8_decode($inscrito->get_nome());
$dadosboleto["endereco1"] = utf8_decode($inscrito->get_endereco());
$dadosboleto["endereco2"] = utf8_decode($inscrito->get_cidade()." - ".$inscrito->get_uf()." - CEP: ".$inscrito->get_cep());
